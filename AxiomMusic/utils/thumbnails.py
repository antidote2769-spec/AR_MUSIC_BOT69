...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        ...
        try:
            title_font = ImageFont.truetype("AxiomMusic/assets/assets/cfont.ttf", 40)
            meta_font = ImageFont.truetype("AxiomMusic/assets/assets/f.ttf", 22)
            time_font = ImageFont.truetype("AxiomMusic/assets/assets/f.ttf", 19)
        except OSError:
