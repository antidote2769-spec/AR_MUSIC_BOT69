...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        ...
        try:
            title_font = ImageFont.truetype("AxiomMusic/assets/assets/font2.ttf", 40)
            meta_font = ImageFont.truetype("AxiomMusic/assets/assets/font.ttf", 22)
            time_font = ImageFont.truetype("AxiomMusic/assets/assets/font.ttf", 19)
        except OSError:
