...
from AxiomMusic.utils.formatters import formats
...
from AxiomMusic.utils.logger import play_logs
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if not config.SPOTIFY_CLIENT_ID and not config.SPOTIFY_CLIENT_SECRET:
                return await mystic.edit_text(
                    "<blockquote expandable><b>✧ sᴘᴏᴛɪғʏ ɪs ɴᴏᴛ sᴜᴘᴘᴏʀᴛᴇᴅ ʏᴇᴛ.\n\nᴘʟᴇᴀsᴇ ᴛʀʏ ᴀɢᴀɪɴ ʟᴀᴛᴇʀ. </b></blockquote>"
                )
            if "track" in url:
                try:
            ...
            return await mystic.edit_text("<blockquote expandable><b>✧ ❌ SoundCloud streaming and downloading is currently disabled. </b></blockquote>")
        else:
            try:
                await Axiomm.stream_call(url)
...
async def Anumous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "<blockquote expandable><b>✧ ʀᴇᴠᴇʀᴛ ʙᴀᴄᴋ ᴛᴏ ᴜsᴇʀ ᴀᴄᴄᴏᴜɴᴛ :\n\nᴏᴘᴇɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ sᴇᴛᴛɪɴɢs.\n-> ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs\n-> ᴄʟɪᴄᴋ ᴏɴ ʏᴏᴜʀ ɴᴀᴍᴇ\n-> ᴜɴᴄʜᴇᴄᴋ ᴀɴᴏɴʏᴍᴏᴜs ᴀᴅᴍɪɴ ᴘᴇʀᴍɪssɪᴏɴs. </b></blockquote>",
            show_alert=True,
        )
    except:
        pass
...
@app.on_callback_query(filters.regex("AxiommPlaylists") & ~BANNED_USERS)
@languageCB
